 ...
 * - Changed gpt structure names and members to be simpler and more LinaOS-like.
 * 
 ...
 * - Moved crc32() to linaos/lib, added efi_crc32().
 *
 ...
 *
 * We do not create a LinaOS partition for GPT, but
