 ...
 * need these:
 *
 * - the master/host side LinaOS-USB kernel driver API;
 * - the "usbfs" user space API; and
 * - the LinaOS "gadget" slave/device/peripheral side driver API.
 *
...
#include <linaos/types.h>	/* __u8 etc */
 ...
 * through the LinaOS-USB APIs, they are not converted to cpu byte
...
/* USB 2.0 defines three speeds, here's how LinaOS identifies them */
