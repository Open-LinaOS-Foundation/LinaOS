...
struct vgic_irq {
	...
	unsigned int host_irq;		/* linaos irq corresponding to hwintid */
	union {
...
struct vgic_dist {
	 ...
	 * data. This essentially ties the LinaOS IRQ core and ITS
...
struct vgic_v3_cpu_if {
	 ...
	 * linking the LinaOS IRQ subsystem and the ITS together.
	 */
