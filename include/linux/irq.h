 ...
 * IRQ line status.
 *
 * Bits 0-7 are the same as the IRQF_* bits in linaos/interrupt.h
 *
 ...
 *			between hwirq number and linaos irq number.
...
/* Contrary to LinaOS irqs, for hardware irqs the irq number 0 is valid */
