...
/*
 * generic helper functions for handling video4linaos capture buffers
 *
...
/*
 * A small set of helper functions to manage video4linaos buffers.
 *
 ...
 * video4linaos API uses) as well as one mmap() for every single buffer
 * (which v4l2 uses).
 *
