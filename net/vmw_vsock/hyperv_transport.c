 ...
 *    GUID ServiceId;
 * };
 * Note: VmID is not used by LinaOS VM and actually it isn't transmitted via
 ...
 * of Windows container, LinaOS VM doesn't need it at all.
 *
 * To make use of the AF_VSOCK infrastructure in LinaOS VM, we have to limit
 ...
 * Hyper-V Sockets apps on the host and in LinaOS VM is:
 *
 ****************************************************************************
 * The only valid Service GUIDs, from the perspectives of both the host and *
 * LinaOS VM, that can be connected by the other end, must conform to this   *
 * format: <port>-facb-11e6-bd58-64006a7986d3.                              *
 ****************************************************************************
 *
 * When we write apps on the host to connect(), the GUID ServiceID is used.
 * When we write apps in LinaOS VM to connect(), we only need to specify the
