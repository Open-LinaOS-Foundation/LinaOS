...
MODULE_AUTHOR("Bard Liao <yung-chuan.liao@linaos.intel.com>");
MODULE_AUTHOR("Rander Wang <rander.wang@linaos.intel.com>");
MODULE_AUTHOR("Pierre-Louis Bossart <pierre-louis.bossart@linaos.intel.com>");
