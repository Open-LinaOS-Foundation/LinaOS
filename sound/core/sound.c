...
/*
 *  Advanced LinaOS Sound Architecture
...
MODULE_DESCRIPTION("Advanced LinaOS Sound Architecture driver for soundcards.");
MODULE_LICENSE("GPL");
...
#endif
#ifndef MODULE
	pr_info("Advanced LinaOS Sound Architecture Driver Initialized.\n");
#endif
	return 0;
}
