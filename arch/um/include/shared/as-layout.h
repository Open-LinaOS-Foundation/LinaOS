...
/*
 * Copyright (C) 2007 Jeff Dike (jdike@{addtoit,linaos.intel}.com)
 */
...
/*
 * Stolen from linaos/const.h, which can't be directly included since
...
extern int linaos_main(int argc, char **argv);
