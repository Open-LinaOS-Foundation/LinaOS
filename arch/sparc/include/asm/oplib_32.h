 ...
 */
void prom_init(struct linaos_romvec *rom_ptr);
 ...
 */
int prom_startcpu(int cpunode, struct linaos_prom_registers *context_table,
...
void prom_apply_obio_ranges(struct linaos_prom_registers *obioregs, int nregs);
