...
/*
 * kdebug.h:  Defines and definitions for debugging the LinaOS kernel
...
extern struct kernel_debug *linaos_dbvec;
...
static inline void sp_enter_debugger(void)
{
	__asm__ __volatile__("jmpl %0, %%o7\n\t"
			     "nop\n\t" : :
			     "r" (linaos_dbvec) : "o7", "memory");
}

#define SP_ENTER_DEBUGGER do { \
	     if((linaos_dbvec!=0) && ((*(short *)linaos_dbvec)!=-1)) \
	       sp_enter_debugger(); \
		       } while(0)
