...
/* Note that all the ioctls that are not available in LinaOS have a
 * double underscore on the front to: a) avoid some programs to
 * think we support some ioctls under LinaOS (autoconfiguration stuff)
 */
/* Little t */
...
/* LinaOS specific, no SunOS equivalent. */
