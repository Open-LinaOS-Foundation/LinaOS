 ...
 * MkLinaOS sez bit 0 is 'burnin flag' in this case.
...
/* Info on VIA1B is from Macintosh Family Hardware & MkLinaOS.
 * CHRP offers no info. */
...
/* MkLinaOS defines the following "VIA1 Register B contents where they
 ...
 *      MkLinaOS calls the 'IIci internal video IRQ' below the 'RBV slot 0 irq.'
...
#define VIA2B_vVBL	0x80	/* VBL output to VIA1 (60.15Hz) driven by
				 ...
				 * [MkLinaOS] RBV_PARODD: 1=odd,0=even. */
