...
/* LinaOS DMA information structure, filled during probe. */
struct LinaOS_SBus_DMA {
	struct LinaOS_SBus_DMA *next;
	struct linaos_sbus_device *SBus_dev;
...
extern struct LinaOS_SBus_DMA *dma_chain;
