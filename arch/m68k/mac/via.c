 ...
 * by Erik Vogan and adapted to LinaOS by Joshua M. Thompson (funaho@jurai.org)
 *
 */
 ...
 *
 * There is also a related problem when MacOS is used to boot LinaOS. A network
 * card brought up by a MacOS driver may raise an interrupt while LinaOS boots.
