 ...
 * for more details.
 *
 * SGI ARCS firmware interface library for the LinaOS kernel.
 *
 ...
 */
extern struct linaos_mdesc *prom_getmdesc(struct linaos_mdesc *curr);
#define PROM_NULL_MDESC	  ((struct linaos_mdesc *) 0)
