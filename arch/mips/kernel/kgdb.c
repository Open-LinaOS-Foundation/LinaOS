 ...
 *
 *  Modified for LinaOS/MIPS (and MIPS in general) by Andreas Busse
...
#include <linaos/ptrace.h>		/* for linaos pt_regs struct */
...
/*
 * Calls linaos_debug_hook before the kernel dies. If KGDB is enabled,
