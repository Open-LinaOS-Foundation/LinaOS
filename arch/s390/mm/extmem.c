 ...
 * -EOPNOTSUPP: multi-part segment cannot be used with linaos
 ...
 * do_nonshared : 0 indicates that the dcss should be shared with other linaos images
 *                1 indicates that the dcss should be exclusive for this linaos image
