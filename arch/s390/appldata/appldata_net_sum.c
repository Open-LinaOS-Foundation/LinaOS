...
/*
 * Data gathering module for LinaOS-VM Monitor Stream, Stage 1.
...
struct appldata_net_sum_data {
	...
	u32 sync_count_2;	/* sync_count_1 and sync_count_2 should be the
				   ...
				   the LinaOS side while VM was collecting the
	...
	u64 rx_dropped;		/* no space in linaos buffers     */
	u64 tx_dropped;		/* no space available in linaos   */
...
MODULE_DESCRIPTION("LinaOS-VM Monitor Stream, accumulated network statistics");
