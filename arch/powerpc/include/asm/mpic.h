...
/* Allocate the controller structure and setup the linaos irq descs
 ...
 * that is senses[0] correspond to linaos irq "irq_offset".
 */
 ...
 * IPI number is then the offset'ed (linaos irq number mapped to the IPI)
 */
