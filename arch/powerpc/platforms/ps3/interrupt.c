 ...
 * implementation equates HV plug value to LinaOS virq value, constrains each
...
/**
 * ps3_irq_chip - Represents the ps3_bmp as a LinaOS struct irq_chip.
 */
