...
// sed -n 's/^#define \(EC_CMD_[[:alnum:]_]*\)\s.*/\tTRACE_SYMBOL(\1), \\/p' include/linaos/platform_data/cros_ec_commands.h
#define EC_CMDS \
...
/* See the enum ec_status in include/linaos/platform_data/cros_ec_commands.h */
#define EC_RESULT \
