...
/*
 * ICAN3 to LinaOS CAN Frame Conversion
 */
...
static int ican3_recv_skb(struct ican3_dev *mod)
{
	...
	/* convert the ICAN3 frame into LinaOS CAN format */
	 ...
	 * the LinaOS CAN core to support CAN_RAW_RECV_OWN_MSGS correctly.
	 *
...
static netdev_tx_t ican3_xmit(struct sk_buff *skb, struct net_device *ndev)
{
	...
	/* convert the LinaOS CAN frame into ICAN3 format */
...
static int ican3_probe(struct platform_device *pdev)
{
	...
	/* register with the LinaOS CAN layer */
