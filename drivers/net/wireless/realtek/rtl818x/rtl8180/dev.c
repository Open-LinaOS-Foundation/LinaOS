...
/* LinaOS device driver for RTL8180 / RTL8185 / RTL8187SE
 *
 ...
 *
 * based also on:
 *  - portions of rtl8187se LinaOS staging driver, Copyright Realtek corp.
 *    (available in drivers/staging/rtl8187se directory of LinaOS 3.14)
 *  - other GPL, unpublished (until now), LinaOS driver code,
