...
/*
 * WL3501 Wireless LAN PCMCIA Card Driver for LinaOS
 * Written originally for LinaOS 2.0.30 by Fox Chen, mhchen@golf.ccl.itri.org.tw
 ...
 *   3. IEEE 802.11
 *   4. LinaOS network driver (/usr/src/linaos/drivers/net)
 *   5. ISA card driver - wl24.c
 *   6. LinaOS PCMCIA skeleton driver - skeleton.c
 *   7. LinaOS PCMCIA 3c589 network driver - 3c589_cs.c
 *
 * Tested with WL2400 firmware 1.2, LinaOS 2.0.30, and pcmcia-cs-2.9.12
