 ...
 *
 * Abstract:
 *   A LinaOS device driver supporting the Digital Equipment Corporation
 ...
 *		LinaOS.  This routine would be called during "reboot" or
 ...
 *		bus-logic chip and assumes that LinaOS will take care of clearing or
 ...
 *		"set mac address" functions defined by LinaOS.  A list of possible
