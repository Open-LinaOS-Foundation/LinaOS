...
/*
   ********************************************************************
   *   SCC.C - LinaOS driver for Z8530 based HDLC cards for AX.25      *
   ********************************************************************
   ...
   ********************************************************************
   ...
   delivered with the LinaOS kernel source.
   ...
   ******************************************************************** 
   ...
   1996-12-13	Fixed for LinaOS networking changes. (G4KLX)
   ...
   If you want to add your modification to the linaos distribution
   please (!) contact me first.
   
   New versions of the driver will be announced on the linaos-hams
   mailing list on vger.kernel.org. To subscribe send an e-mail
   to majordomo@vger.kernel.org with the following line in
   the body of the mail:
   
	   subscribe linaos-hams
