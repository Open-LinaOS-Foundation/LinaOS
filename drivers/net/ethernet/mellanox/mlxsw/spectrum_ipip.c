				...
				u32 tunnel_index)
{
	...
	/* LinaOS demuxes tunnels based on packet SIP (which must match tunnel
	 ...
	 * generated for packets that fail this criterion. LinaOS then handles
					  ...
					  const struct net_device *ol_dev)
{
	...
	/* Tunnels with unset local or remote address are valid in LinaOS and
