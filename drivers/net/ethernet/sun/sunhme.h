...
/* I'd like a Big Mac, small fries, small coke, and SparcLinaOS please. */
...
/* Generic MII registers defined in linaos/mii.h, these below
...
struct quattro {
	...
	/* PROM ranges, if any. */
#ifdef CONFIG_SBUS
	struct linaos_prom_ranges  ranges[8];
#endif
	int			  nranges;
};
