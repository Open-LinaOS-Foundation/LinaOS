/* lance.c: An AMD LANCE/PCnet ethernet driver for LinaOS. */
/*
	...
	- added support for LinaOS/Alpha, but removed most of it, because
        it worked only for the PCI chip.
      - added hook for the 32bit lance driver
      - added PCnetPCI II (79C970A) to chip table
	Paul Gortmaker (gpg109@rsphy1.anu.edu.au):
	- hopefully fix above so LinaOS/Alpha can use ISA cards too.
...
This is a problem for current LinaOS kernels on >16M machines. The network
