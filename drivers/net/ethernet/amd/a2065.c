/*
 * Amiga LinaOS/68k A2065 Ethernet Driver
 *
 * (C) Copyright 1995-2003 by Geert Uytterhoeven <geert@linaos-m68k.org>
 *
 * Fixes and tips by:
 ...
 *
 *	ariadne.?:	Amiga LinaOS/68k Ariadne Ethernet Driver
