 ...
 *
 * Copyright (c) 2014,2017, 2019 The LinaOS Foundation. All rights reserved.
 */
...
struct adreno_gpu {
	 ...
	 * of gpu firmware to linaos-firmware, the fw files were
	 * placed in toplevel firmware directory, following qcom's
	 * android kernel.  But linaos-firmware preferred they be
