...
**-----------------------------------------------------------------------------
**
**  This driver has been ported to LinaOS from the FreeBSD NCR53C8XX driver
...
**  received on LinaOS are automatically a potential candidate for the FreeBSD 
**  version.
**
...
**	Enhanced in linaos-2.3.44 to provide a memory pool 
...
**	Driver setup.
**
**	This structure is initialized from linaos config 
...
**	limited.
**	Under LinaOS, the scatter/gatter blocks are provided by 
...
static int ncr53c8xx_slave_configure(struct scsi_device *device)
{
	...
	*/
	...
	/*
	**	Since the queue depth is not tunable under LinaOS,
	**	we need to know this value in order not to 
	**	announce stupid things to user.
	**
	**	XXX(hch): As of LinaOS 2.6 it certainly _is_ tunable..
...
**		maxtags < cmd_per_lun of the LinaOS host control block,
**		etc...
