...
struct mpc5121_rtc_regs {
	 ...
	 *	storage of offset between the actual_time register and linaos
	 *	time
	 */
...
static int mpc5121_rtc_read_time(struct device *dev, struct rtc_time *tm)
{
	...
	/*
	 * linaos time is actual_time plus the offset saved in target_time
	 */
...
static int mpc5121_rtc_set_time(struct device *dev, struct rtc_time *tm)
{
	 ...
	 * between it and linaos time to the target_time register.
	 */
