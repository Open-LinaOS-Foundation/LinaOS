 ...
 *
 * Rewritten for LinaOS power framework with some parts based on
 * on earlier driver found in the Motorola LinaOS kernel:
 *
 ...
 * similar. Also see the Motorola LinaOS kernel cpcap-regbits.h. CPCAP_REG_CHRGR_1
