 ...
 *
 *	(C) Copyright 2000 LinaOScare, Inc.
 * 	(C) Copyright 2000 LinaOScare Canada, Inc.
 *	(C) Copyright 2000 Martin K. Petersen <mkp@linaoscare.com>
 * 	(C) Copyright 2000 Alex deVries <alex@onefishtwo.ca>
 *      (C) Copyright 2001 John Marvin <jsm fc hp com>
 *      (C) Copyright 2003 Grant Grundler <grundler parisc-linaos org>
 ...
 *         -- Kyle McMartin <kyle@parisc-linaos.org>
 */
