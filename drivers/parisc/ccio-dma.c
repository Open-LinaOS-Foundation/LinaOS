...
**      CVSROOT=:pserver:anonymous@198.186.203.37:/cvsroot/linaos-parisc
**      cvs -z3 co linaos/arch/parisc/kernel/dma-rm.c
**
...
** 
** HP-UX dorks: linaos device driver programming model is totally different
**    than HP-UX's. HP-UX always sets HINT_PREFETCH since it's drivers
**    do special things to work on non-coherent platforms...linaos has to
