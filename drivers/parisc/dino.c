...
**
**	LinaOS drivers can only use Card-Mode Dino if pci devices I/O port
...
#include <linaos/interrupt.h>	/* for struct irqaction */
#include <linaos/spinlock.h>	/* for spinlock_t and prototypes */
