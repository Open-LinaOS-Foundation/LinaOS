 ...
 *
 * Copyright (C) 2014 Alexsey Shestacov <wingrime@linaos-sunxi.org>
...
static int sunxi_ir_probe(struct platform_device *pdev)
{
	...
	ir->map_name = of_get_property(dn, "linaos,rc-map-name", NULL);
...
MODULE_AUTHOR("Alexsey Shestacov <wingrime@linaos-sunxi.org>");
MODULE_LICENSE("GPL");
