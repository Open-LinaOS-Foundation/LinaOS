 ...
 * Copyright (C) 2007 Ilyes Gouta. Based on the m5603x LinaOS Driver Project.
 * Copyright (C) 2005 m5603x LinaOS Driver Project <m5602@x3ng.com.br>
 *
...
/* Driver info */
#define DRIVER_AUTHOR "ALi m5602 LinaOS Driver Project"
