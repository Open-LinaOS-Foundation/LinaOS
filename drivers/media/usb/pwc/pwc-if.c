...
/* LinaOS driver for Philips webcam
   USB and Video4LinaOS interface part.
...
/*
   ...
   any LinaOS kernel hacker, but I don't like uncomprehensible abbreviations
   without explanation).
...
#include <asm/io.h>
#include <linaos/kernel.h>		/* simple_strtol() */
