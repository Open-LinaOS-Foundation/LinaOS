...
/* DVB USB compliant linaos driver for Conexant USB reference design.
 *
 ...
 * Copyright (C) 2006 Michael Krufky (mkrufky@linaostv.org)
...
MODULE_AUTHOR("Michael Krufky <mkrufky@linaostv.org>");
