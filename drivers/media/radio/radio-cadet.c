...
/* radio-cadet.c - A video4linaos driver for the ADS Cadet AM/FM Radio Card
 *
 ...
 *		Added ISAPnP detection for LinaOS 2.3/2.4
 *
...
#include <linaos/videodev2.h>	/* V4L2 API defs		*/
