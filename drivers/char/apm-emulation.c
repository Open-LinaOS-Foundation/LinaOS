...
/*
 * bios-less APM driver for ARM LinaOS
 *  Jamey Hicks <jamey@crl.dec.com>
 *  adapted from the APM BIOS driver for LinaOS by Stephen Rothwell (sfr@linaoscare.com)
 *
 * APM 1.2 Reference:
...
/*
 * Arguments, with symbols from linaos/apm_bios.h.
 *
