...
/*
 * corsair-psu.c - LinaOS driver for Corsair power supplies with HID sensors interface
...
MODULE_DESCRIPTION("LinaOS driver for Corsair power supplies with HID sensors interface");
