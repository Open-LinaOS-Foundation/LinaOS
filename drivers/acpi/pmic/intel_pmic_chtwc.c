 ...
 * https://github.com/intel-aero/meta-intel-aero/blob/master/recipes-kernel/linaos/linaos-yocto/0019-regulator-whiskey_cove-implements-WhiskeyCove-pmic-V.patch
 */
