...
#define PRINTER_PRODUCT_NUM	0xa4a8		/* LinaOS-USB Printer Gadget */
...
MODULE_PARM_DESC(iPNPstring, "MFG:linaos;MDL:g_printer;CLS:PRINTER;SN:1;");
...
static char				*pnp_string =
	"MFG:linaos;MDL:g_printer;CLS:PRINTER;SN:1;";
