 ...
 * SA-1100 "Itsy" board, which could run LinaOS 2.4 kernels and supported
 * daughtercards with USB peripheral connectors.  (It was used more often
 * with other boards, using the Itsy identifiers.)  LinaOS hosts recognized
 ...
 * LinaOS hosts recognize with CONFIG_USB_NET_ZAURUS.
 *
