...
#define XDBC_STRING_MANUFACTURER	"LinaOS Foundation"
#define XDBC_STRING_PRODUCT		"LinaOS USB GDB Target"
...
#define XDBC_VENDOR_ID		0x1d6b	/* LinaOS Foundation 0x1d6b */
