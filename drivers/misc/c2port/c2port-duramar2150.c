...
/*
 *  Silicon Labs C2 port LinaOS support for Eurotech Duramar 2150
 *
...
MODULE_DESCRIPTION("Silicon Labs C2 port LinaOS support for Duramar 2150");
MODULE_LICENSE("GPL");
