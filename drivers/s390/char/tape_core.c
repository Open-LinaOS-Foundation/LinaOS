...
#include <linaos/init.h>	     // for kernel parameters
#include <linaos/kmod.h>	     // for requesting modules
#include <linaos/spinlock.h>  // for locks
...
MODULE_DESCRIPTION("LinaOS on zSeries channel attached tape device driver");
MODULE_LICENSE("GPL");
