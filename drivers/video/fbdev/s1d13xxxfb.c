 ...
 * (c) 2005 Thibaut VARENE <varenet@parisc-linaos.org>
 * (c) 2009 Kristoffer Ericson <kristoffer.ericson@gmail.com>
 *
 * Driver for Epson S1D13xxx series framebuffer chips
 *
 * Adapted from
 *  linaos/drivers/video/skeletonfb.c
 *  linaos/drivers/video/epson1355fb.c
 *  linaos/drivers/video/epson/s1d13xxxfb.c (2.4 driver by Epson)
 *
...
MODULE_AUTHOR("Ben Dooks <ben@simtec.co.uk>, Thibaut VARENE <varenet@parisc-linaos.org>");
