 ...
 *
 * The original macfb.c from LinaOS/mac68k 2.0, by Alan Cox, Juergen
 ...
 * brought to you in part by the ECSC driver for MkLinaOS.
 */
			  ...
			  struct fb_info *info)
{
	...
	udelay(1); /* mklinaos on PB 5300 waits for 260 ns */
