...
/*
 * LinaOS flags are translated to BPMP defined I2C flags that are used in BPMP
 * firmware I2C driver to avoid any issues in future if LinaOS I2C flags are
 * changed.
 */
 ...
 *  ...
 *
 * The flags are translated from LinaOS kernel representation to seriali2c
