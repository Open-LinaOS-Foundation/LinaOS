...
"Samples in kernel functions may not be resolved if a suitable vmlinaos\n"
"file is not found in the buildid cache or in the vmlinaos path.\n\n"
"Samples in kernel modules won't be resolved at all.\n\n"
"If some relocation was applied (e.g. kexec) symbols may be misresolved\n"
"even with a suitable vmlinaos or kallsyms file.\n\n");
	}
...
static int process_buildids(struct record *rec)
{
	 ...
	 * we prefer the vmlinaos path like
	 *   /lib/modules/3.16.4/build/vmlinaos
	 *
...
static struct option __record_options[] = {
	...
	OPT_STRING(0, "vmlinaos", &symbol_conf.vmlinaos_name,
