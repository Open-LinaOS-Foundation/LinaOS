...
/******************************************************************************
 *
 * Module Name: oslinaostbl - LinaOS OSL for obtaining ACPI tables
 *
 ...
 *
 * NOTE:        This works on LinaOS as table customization does not modify the
 ...
 *
 * PARAMETERS:  pathname        - Directory to find LinaOS customized table
