...
# Copyright (c) 2020 Shuah Khan <skhan@linaosfoundation.org>
#
#
...
echo -e "\tkselftest_deps.sh [-p] aarch64-linaos-gnu-gcc"
echo -e "\tkselftest_deps.sh [-p] aarch64-linaos-gnu-gcc vm\n"
