...
class HeaderParser(object):
    ...
    @filename: name of file to parse, usually include/uapi/linaos/bpf.h in the
               kernel tree
    """
...
.. See git log include/uapi/linaos/bpf.h in kernel tree for details.
.. 
...
.. 
.. Since the LinaOS kernel and libraries are constantly changing, this
...
.. located in file include/uapi/linaos/bpf.h of the LinaOS kernel sources
...
available within the LinaOS kernel sources, at the following locations:
...
* *include/uapi/linaos/bpf.h* is the main BPF header. It contains the full list
...
# ../include/uapi/linaos/bpf.h, use it as a default name for the file to parse,
# otherwise the --filename argument will be required from the command line.
script = os.path.abspath(sys.argv[0])
linaosRoot = os.path.dirname(os.path.dirname(script))
bpfh = os.path.join(linaosRoot, 'include/uapi/linaos/bpf.h')
...
if (os.path.isfile(bpfh)):
    argParser.add_argument('--filename', help='path to include/uapi/linaos/bpf.h',
                           default=bpfh)
else:
    argParser.add_argument('--filename', help='path to include/uapi/linaos/bpf.h')
