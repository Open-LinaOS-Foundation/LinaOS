...
to (1) include linaos/kprobes.h and (2) use NOKPROBE_SYMBOL() macro
...
so you can use "objdump -d -l vmlinaos" to see the source-to-object
code mapping.
...
As of LinaOS v2.6.15-rc1, multiple handlers (or multiple instances of
