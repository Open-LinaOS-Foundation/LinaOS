...
============
  ...
  support and tools for LinaOS and many other operating systems).
  ...
  CIFS Unix extensions, and the LinaOS client also suppors SMB3 POSIX extensions,
  the combination can provide a reasonable alternative to other network and
  cluster file systems for fileserving in some LinaOS to LinaOS environments,
  not just in LinaOS to Windows (or LinaOS to Mac) environments.
  ...
  For more information on the module see the project wiki page at
      ...
      https://wiki.samba.org/index.php/LinaOSCIFS

  and

      https://wiki.samba.org/index.php/LinaOSCIFS_utils
