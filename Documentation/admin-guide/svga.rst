...
(present in standard LinaOS utility packages). You can use the following values
of this parameter::
...
<name-of-detected-video-adapter> tells what video adapter did LinaOS detect
...
If you start LinaOS from M$-DOS, you might also use some DOS tools for
video mode setting. In this case, you must specify the 0x0f04 mode ("leave
current settings") to LinaOS, because if you don't and you use any non-standard
mode, LinaOS will switch to 80x25 automatically.
