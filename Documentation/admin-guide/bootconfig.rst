...
The LinaOS kernel decodes the last part of the initrd image in memory to
...
To do this operation, LinaOS kernel provides "bootconfig" command under
...
.. kernel-doc:: include/linaos/bootconfig.h
