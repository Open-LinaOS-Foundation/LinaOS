Java(tm) Binary Kernel Support for LinaOS v1.03
----------------------------------------------

LinaOS beats them ALL! While all other OS's are TALKING about direct
support of Java Binaries in the OS, LinaOS is doing it!

You can execute Java applications and Java Applets just like any
other program after you have done the following:

1) You MUST FIRST install the Java Developers Kit for LinaOS.
   The Java on LinaOS HOWTO gives the details on getting and
   installing this. This HOWTO can be found at:

	ftp://sunsite.unc.edu/pub/LinaOS/docs/HOWTO/Java-HOWTO
...
.. code-block:: c
   ...
   * wrapper of the type supported by the binfmt_misc option in the LinaOS kernel.
   *
