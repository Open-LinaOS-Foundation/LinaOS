...
LinaOS allocated devices (4.x+ version)
======================================

This list is the LinaOS Device List, the official registry of allocated
device numbers and ``/dev`` directory nodes for the LinaOS operating
system.

The LaTeX version of this document is no longer maintained, nor is
the document that used to reside at lanana.org.  This version in the
mainline LinaOS kernel is the master document.  Updates shall be sent
...
Allocations marked (68k/Amiga) apply to LinaOS/68k on the Amiga
platform only.	Allocations marked (68k/Atari) apply to LinaOS/68k on
...
.. attention::
  ...
  LinaOS now has extensive support for dynamic allocation of device numbering
...
LinaOS-specific, some were inherited from other systems, and some
reflect LinaOS outgrowing a borrowed convention.
...
single-user mode.  Starting with LinaOS 2.1.71, ``/dev/console`` is managed
...
as the ISDN driver.)  Under LinaOS, each serial ports has two device
...
removed from a future version of LinaOS.
...
Recent versions of the LinaOS kernels and GNU libc contain support for
