...
(see ``KEY_SYSRQ`` in ``include/uapi/linaos/input-event-codes.h``), or
...
the header ``include/linaos/sysrq.h``, this will define everything else you need.
...
Just ask them on the linaos-kernel mailing list:
