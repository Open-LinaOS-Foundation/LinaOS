...
the LinaOS kernel.  This support is built on top of multiple page size support
...
Users can use the huge page support in LinaOS kernel by either using the mmap
system call or standard SYSV shared memory system calls (shmget, shmat).

First the LinaOS kernel needs to be built with the CONFIG_HUGETLBFS
