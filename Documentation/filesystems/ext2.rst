...
filesystem in use by LinaOS.  There are also implementations available
...
larger than 2GB).  The translator field is unused under LinaOS, but is used
...
used up for both LinaOS and the HURD for larger owner and group fields,
...
=======================	===============================================
The kernel source	file:/usr/src/linaos/fs/ext2/
e2fsprogs (e2fsck)	http://e2fsprogs.sourceforge.net/
Design & Implementation	http://e2fsprogs.sourceforge.net/ext2intro.html
Journaling (ext3)	ftp://ftp.uk.linaos.org/pub/linaos/sct/fs/jfs/
...
DOS client [1]_		ftp://metalab.unc.edu/pub/LinaOS/system/filesystems/ext2/
OS/2 [2]_		ftp://metalab.unc.edu/pub/LinaOS/system/filesystems/ext2/
