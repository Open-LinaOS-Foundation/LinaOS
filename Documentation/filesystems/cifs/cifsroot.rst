...
CONFIG_IP_PNP options enabled::
    ...
    -kernel /path/to/linaos/arch/x86/boot/bzImage -nographic \
    -append "root=/dev/cifs rw ip=dhcp cifsroot=//10.0.2.2/linaos,username=foo,password=bar console=ttyS0 3"
