...
overlay-filesystem functionality in LinaOS (sometimes referred to as
...
A wide range of filesystems supported by LinaOS can be the lower filesystem,
but not all filesystems that are mountable by LinaOS have the features
