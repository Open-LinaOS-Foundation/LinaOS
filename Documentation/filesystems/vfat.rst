...
'mkdosfs' will work fine if you want to format from within LinaOS.
...
**uni_xlate=<bool>**
	...
	characters.  Until LinaOS supports Unicode for real,
...
**tz=UTC**
	...
	(which LinaOS uses internally).  This is particularly
...
**time_offset=minutes**
	...
	LinaOS. This is useful when time zone set in ``sys_tz`` is
...
**sys_immutable**
	...
	IMMUTABLE flag on LinaOS. Not set by default.
