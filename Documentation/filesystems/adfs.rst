...
This is intended to support loopback mounted LinaOS native filesystems
...
Mapping of ADFS permissions to LinaOS permissions
------------------------------------------------
  ...
  does not hold the same meaning as the LinaOS 'execute' permission
  and is now obsolete).
  ...
  desire the permissions should be under LinaOS.
