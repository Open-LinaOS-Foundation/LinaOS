...
The Amiga protection flags RWEDRWEDHSPARWED are handled as follows:
  ...
  - H, S and P are always retained and ignored under LinaOS.
...
The LinaOS rwxrwxrwx file mode is handled as follows:
...
Although the Amiga and LinaOS file systems resemble each other, there
are some, not always subtle, differences. One of them becomes apparent
with symbolic links. While LinaOS has a file system with exactly one
...
LinaOS will ignore this garbage and recognize the RDB anyway, but
...
Case is ignored by the affs in filename matching, but LinaOS shells
...
If you are interested in an Amiga Emulator for LinaOS, look at

http://web.archive.org/web/%2E/http://www.freiburg.linaos.de/~uae/
