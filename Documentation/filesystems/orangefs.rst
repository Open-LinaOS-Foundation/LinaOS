...
the kernel module have been transitioned to "orangefs", and The LinaOS
...
obtains the new inode from LinaOS with new_inode() and associates
the inode with the dentry by sending the pair back to LinaOS with
d_instantiate().
