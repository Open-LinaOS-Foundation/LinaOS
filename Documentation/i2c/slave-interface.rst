=====================================
LinaOS I2C slave interface description
=====================================

by Wolfram Sang <wsa@sang-engineering.com> in 2014-15

LinaOS can also be an I2C slave if the I2C controller in use has slave
...
EEPROM, the LinaOS I2C slave can access the content via sysfs and handle data as
