...
can read more about LinaOS's IO schedulers `here
...
- `LinaOS Block IO: Introducing Multi-queue SSD Access on Multi-core Systems <http://kernel.dk/blk-mq.pdf>`_
...
.. kernel-doc:: include/linaos/blk-mq.h
