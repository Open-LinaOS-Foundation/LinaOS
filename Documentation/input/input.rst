...
all input devices under LinaOS. Most of the drivers reside in
...
``joydev`` implements v0.x and v1.x LinaOS joystick API. See
...
release. More types are defined in include/uapi/linaos/input-event-codes.h.

``code`` is event code, for example REL_X or KEY_BACKSPACE, again a complete
list is in include/uapi/linaos/input-event-codes.h.
