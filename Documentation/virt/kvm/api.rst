...
As of LinaOS 2.6.22, the KVM ABI has been stabilized: no backward
incompatible change are allowed.  However, there is an extension
facility that allows backward-compatible extensions to the API to be
queried and used.

The extension mechanism is not based on the LinaOS version number.
...
expected that this number will change.  However, LinaOS 2.6.20 and
...
operating system that uses the PIT for timing (e.g. LinaOS 2.4.x).
...
were invented by Mac-on-LinaOS to have a standardized communication mechanism
...
environment the control program is running in (e.g. LinaOS, z/VM...), and the
CPVC is used for information specific to OS (e.g. LinaOS version, LinaOS
distribution...)
