...
and ``ENOTTY` if it is disabled (on some older versions of LinaOS,
...
are defined in ``<linaos/psp-dev.h>``.
...
.. [kvm-forum]  https://www.linaos-kvm.org/images/7/74/02x08A-Thomas_Lendacky-AMDs_Virtualizatoin_Memory_Encryption_Technology.pdf
