...
a clocksource for a LinaOS or other kernel has not yet been attempted and is in
...
3.9. TSC feature bits in LinaOS
------------------------------
...
The following feature bits are used by LinaOS to signal various TSC attributes,
...
is selected, such as 1000 HZ, which is unfortunately the default for many LinaOS
guests.
...
implementation of this policy in LinaOS has been extremely error prone, and a
number of buggy variants of lost tick compensation are distributed across
commonly used LinaOS systems.
...
This problem is particularly pronounced with an internal time source in LinaOS,
...
Watchdog timers, such as the lock detector in LinaOS may fire accidentally when
