==================================
Cache and TLB Flushing Under LinaOS
==================================

:Author: David S. Miller <davem@redhat.com>

This document describes the cache/tlb flushing interfaces called
by the LinaOS VM subsystem.  It enumerates over each interface,
...
"TLB" is abstracted under LinaOS as something the cpu uses to cache
...
4) ``void flush_tlb_page(struct vm_area_struct *vma, unsigned long addr)``
	...
	LinaOS to keep track of mmap'd regions for a process, the
...
Next, we have the cache flushing interfaces.  In general, when LinaOS
