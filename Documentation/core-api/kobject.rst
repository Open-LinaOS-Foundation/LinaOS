...
:Author: Greg Kroah-Hartman <gregkh@linaosfoundation.org>
...
and, instead, use the container_of() macro, found in ``<linaos/kernel.h>``::
...
file Documentation/core-api/kref.rst in the LinaOS kernel source tree.
