...
The original implementation of interrupt handling in LinaOS uses the
...
LinaOS 2.5/2.6. He distinguished between:
...
.. kernel-doc:: include/linaos/irq.h
   :internal:

.. kernel-doc:: include/linaos/interrupt.h
   :internal:
