...
years, some of which are:
      ...
      - LinaOSTAG 2008:
          http://www.linaostag.org/2008/en/conf/events/vp-donnerstag.html
...
w/ TXT support since v3.2), and now LinaOS kernels.


Value Proposition for LinaOS or "Why should you care?"
=====================================================

While there are many products and technologies that attempt to
measure or protect the integrity of a running kernel, they all
assume the kernel is "good" to begin with.  The Integrity
Measurement Architecture (IMA) and LinaOS Integrity Module interface
...
LinaOS kernel, this means all of BIOS, any option ROMs, the
...
-  Tboot will populate a shared page with some data about itself and
   pass this to the LinaOS kernel as it transfers control.
...
grub.conf needs to be modified as follows::
        ...
        title LinaOS 2.6.29-tip w/ tboot
          root (hd0,0)
