...
LinaOS users to use the full capabilities of their hardware has been inspired 
...
Until recently, emu10k1 users on LinaOS did not have access to the same low
...
channels.  With a post 2.6.9 LinaOS kernel, latencies down to 64 (1.33 ms) or
