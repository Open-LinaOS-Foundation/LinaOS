...
* hwpoison-inject module through debugfs ``/sys/kernel/debug/hwpoison/``
  ...
  unpoison-pfn
	...
	a page can be reused again.  This only works for LinaOS
  ...
  corrupt-filter-flags-mask, corrupt-filter-flags-value
	...
	flag bits are defined in include/linaos/kernel-page-flags.h and
...
http://halobates.de/mce-lc09-2.pdf
	Overview presentation from LinaOSCon 09
