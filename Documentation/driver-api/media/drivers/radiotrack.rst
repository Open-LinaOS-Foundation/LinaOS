...
This document was made based on 'C' code for LinaOS from Gideon le Grange
...
converting to LinaOS, I found Gideon le Grange's command-line software for
...
LinaOS and gained some insights about the hardware design used for the card.
