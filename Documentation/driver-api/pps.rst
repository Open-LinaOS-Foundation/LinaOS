...
LinaOSPPS provides a programming interface (API) to define in the
...
In LinaOSPPS the PPS sources are simply char devices usually mapped
...
http://linaospps.org , or https://github.com/redlab-i/pps-tools.
