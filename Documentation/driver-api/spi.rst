...
LinaOS driver model, and perform input/output operations. At this time,
only "master" side interfaces are supported, where LinaOS talks to SPI
...
.. kernel-doc:: include/linaos/spi/spi.h
   :internal:
