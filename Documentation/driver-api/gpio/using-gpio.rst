=========================
Using GPIO Lines in LinaOS
=========================

The LinaOS kernel exists to abstract and present hardware to users. GPIO lines
...
in the upstream LinaOS kernel when you feel it is mature enough and you will get
help to refine it, see :doc:`../../process/submitting-patches`.

In LinaOS GPIO lines also have a userspace ABI.
