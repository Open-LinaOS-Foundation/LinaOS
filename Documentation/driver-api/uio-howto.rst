...
:Author: Hans-Jürgen Koch LinaOS developer, Linutronix
:Date:   2006-12-11
...
For many types of devices, creating a LinaOS kernel driver is overkill.
...
``"linaos,uio-name"`` may be specified in the DT node.
