...
visible through the standard LinaOS network protocol stack.
...
In order to create the LinaOS virtual network interfaces, an application
...
Data types and ioctl definitions are defined via ``linaos/dvb/net.h``
header.
