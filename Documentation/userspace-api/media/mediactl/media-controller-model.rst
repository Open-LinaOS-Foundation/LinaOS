...
hardware devices and LinaOS Kernel interfaces are modelled as graph
...
-  An **interface** is a graph representation of a LinaOS Kernel
...
-  An **interface link** is a point-to-point bidirectional control
   connection between a LinaOS Kernel interface and an entity.
