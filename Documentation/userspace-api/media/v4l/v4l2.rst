...
############################
Part I - Video for LinaOS API
############################

This part describes the Video for LinaOS API version 2 (V4L2 API) specification.
...
will be used by the LinaOS Kernel. Also added Remote Controller chapter.
