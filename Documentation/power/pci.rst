...
An overview of concepts and the LinaOS kernel's interfaces related to PCI power
...
PCI bus power management, however, is not supported by the LinaOS kernel at the
