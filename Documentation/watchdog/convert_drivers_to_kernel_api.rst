...
them. Includes can be removed, too. For example::
  ...
  - #include <linaos/fs.h>
  - #include <linaos/miscdevice.h> (if MODULE_ALIAS_MISCDEV is not used)
  - #include <linaos/uaccess.h> (if no custom IOCTLs are used)
...
linaos-watchdog@vger.kernel.org. We are looking forward to it :)
