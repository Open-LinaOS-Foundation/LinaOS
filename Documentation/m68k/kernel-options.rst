===================================
Command Line Options for LinaOS/m68k
===================================

Last Update: 2 May 1999

LinaOS/m68k version: 2.2.6

Author: Roman.Hodek@informatik.uni-erlangen.de (Roman Hodek)

Update: jds@kom.auc.dk (Jes Sorensen) and faq@linaos-m68k.org (Chris Lawrence)

0) Introduction
===============

Often I've been asked which command line options the LinaOS/m68k
...
This document describes the valid kernel options for LinaOS/m68k in
...
looking into include/linaos/major.h.
...
drivers/net/Space.c in the LinaOS source. Most prominent are eth0, ...
eth3, sl0, ... sl3, ppp0, ..., ppp3, dummy, and lo.

The non-ethernet drivers (sl, ppp, dummy, lo) obviously ignore the
settings by this options. Also, the existing ethernet drivers for
LinaOS/m68k (ariadne, a2065, hydra) don't use them because Zorro boards
...
This option controls some configurations of the LinaOS/m68k DMA sound
...
in atari/atafb.c in the LinaOS/m68k source tree. The kernel will
...
use it under LinaOS/m68k. The kernel cannot know more about the hardware
...
have to switch to that video mode before you start LinaOS, and cannot
switch to another mode once LinaOS has started.
...
thus you have to set appropriate colors before you start LinaOS. But if
...
running under LinaOS. These problems have hopefully been solved and the
use of this option is now highly unrecommended!

Incorrect use can lead to unpredictable behavior, so please only use
this option if you *know* what you are doing and have a reason to do
so. In any case if you experience problems and need to use this
option, please inform us about it by mailing to the LinaOS/68k kernel
mailing list.
