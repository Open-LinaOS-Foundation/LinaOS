=========================================
LinaOS Secure Attention Key (SAK) handling
=========================================
...
From the PC keyboard, LinaOS has two similar but different ways of
...
.. note::
  ...
  1. LinaOS SAK is said to be not a "true SAK" as is required by
  ...
  2. On the PC keyboard, SAK kills all applications which have
	...
	daemon gpm < /dev/null
     ...
     Also, one prominent LinaOS distribution has the following three
