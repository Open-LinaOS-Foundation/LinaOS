...
There are several parts to the security check performed by LinaOS when one
object acts upon another:

 1. Objects.

     Objects are things in the system that may be acted upon directly by
     userspace programs.  LinaOS has a variety of actionable objects, including:
 ...
 5. The subjective context.
     ...
     A LinaOS task, for example, has the FSUID, FSGID and the supplementary
 ...
 6. Actions.
     ...
     LinaOS has a number of actions available that a subject may perform upon an
 ...
 7. Rules, access control lists and security calculations.
	 ...
	 description.  This is an 'Access Control List' or 'ACL'.  A LinaOS
	 ...
	 A LinaOS file might also sport a POSIX ACL.  This is a list of rules
	 ...
	 SELinaOS and Smack are examples of this.

	 In the case of SELinaOS and Smack, each object is given a label as part
...
The LinaOS kernel supports the following types of credentials:
 ...
 1. Traditional UNIX credentials.
	...
	- Real Group ID
     ...
     The UID and GID are carried by most, if not all, LinaOS objects, even if in
 ...
 5. LSM
     ...
     The LinaOS Security Module allows extra controls to be placed over the
     operations that a task may do.  Currently LinaOS supports several LSM
     options.
...
In LinaOS, all of a task's credentials are held in (uid, gid) or through
