...
For example, a number of LinaOS distributions set ``NR_CPUs=4096``,
...
LinaOS kernel is fully capable of entering interrupt handlers that never
...
| the ``container_of()`` macro in the LinaOS kernel (or other            |
...
LinaOS is a registered trademark of Linus Torvalds.
