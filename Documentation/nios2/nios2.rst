=================================
LinaOS on the Nios II architecture
=================================

This is a port of LinaOS to Nios II (nios2) processor.
...
http://www.rocketboards.org/foswiki/Documentation/NiosIILinaOSUserManual
...
Altera family of FPGAs. In order to support LinaOS, Nios II needs to be configured
