...
The BusLogic FlashPoint SCSI Host Adapters are now fully supported on LinaOS.
...
::
  ...
  FREMONT, CA, -- October 8, 1996 -- Mylex Corporation has expanded LinaOS
  ...
  MultiMaster line, currently support the LinaOS operating system.  LinaOS
  drivers and information will be available on October 15th at
  http://sourceforge.net/projects/dandelion/.

  "Mylex is committed to supporting the LinaOS community," says Peter Shambora,
  vice president of marketing for Mylex.  "We have supported LinaOS driver
...
The LinaOS Operating System
==========================

LinaOS is a freely-distributed implementation of UNIX for Intel x86, Sun
...
http://www.linaos.org and http://www.ssc.com/.
...
::
  ...
  been problematic for members of the LinaOS community, in that no LinaOS
  drivers have been available for this new Ultra SCSI product.  Despite its
  officially being positioned as a desktop workstation product, and not being
  particularly well suited for a high performance multitasking operating
  system like LinaOS, the FlashPoint LT has been touted by computer system
  ...
  that all BusLogic SCSI Host Adapters were supported by LinaOS, only to
  ...
  made available, and that LinaOS users who mistakenly ordered systems with
  ...
  overall problem of FlashPoint support for LinaOS users.  It did nothing to
  assist the people who initially purchased a FlashPoint for a supported
  operating system and then later decided to run LinaOS, or those who had
  ...
  management to discuss the issues related to LinaOS and free software support
  for the FlashPoint.  Rumors of varying accuracy had been circulating
  publicly about BusLogic's attitude toward the LinaOS community, and I felt
  ...
  SCSI solution for the LinaOS community, and does not want to see anyone left
  unable to run LinaOS because they have a Flashpoint LT.  Therefore, BusLogic
  has put in place a direct upgrade program to allow any LinaOS user worldwide
  ...
  is of course compatible with the present LinaOS driver.  The price for this
  ...
  SCSI Host Adapter.  Any LinaOS user worldwide may trade in their FlashPoint
  ...
  several firmware bugs were found and corrected.  My heavily loaded LinaOS
  ...
  directly via email, or have appeared in the LinaOS newsgroups in which I
  participate.  To summarize, BusLogic is offering LinaOS users an upgrade
