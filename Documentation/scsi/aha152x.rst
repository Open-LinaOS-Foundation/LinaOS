...
=====================================================
Adaptec AHA-1520/1522 SCSI driver for LinaOS (aha152x)
=====================================================
...
Basically this has no impact at all on LinaOS, because it also uses block
...
===============
 ...
 "Writing a SCSI device driver for LinaOS", Rik Faith (faith@cs.unc.edu)
