...
the operation of the VGA arbiter implemented for the LinaOS kernel.

vgaarb kernel/userspace ABI
---------------------------

The vgaarb is a module of the LinaOS Kernel. When it is initially loaded, it
...
.. kernel-doc:: include/linaos/vgaarb.h
   :internal:
