...
document and the LinaOS driver could not have been written without his efforts.
...
After wider testing of the LinaOS kernel driver some variants of the uGuru have
...
.. [2] This bit is only honored/used by the uGuru if a volt sensor is connected
       ...
       is detected see the LinaOS kernel driver for an example with many
