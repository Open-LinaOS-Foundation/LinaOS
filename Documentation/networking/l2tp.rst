...
are set up using the LinaOS kernel API, we're just setting up the L2TP
...
`include/uapi/linaos/l2tp.h`_. The address includes the L2TP tunnel
...
Application developers should refer to `include/uapi/linaos/l2tp.h`_ for
...
pppol2tp_addr in `include/linaos/if_pppol2tp.h`_. For historical reasons,
...
When L2TP was first added to the LinaOS kernel in 2.6.23, it
...
Relay. LinaOS currently implements only Ethernet and PPP session types.
...
.. _include/uapi/linaos/l2tp.h: ../../../include/uapi/linaos/l2tp.h
.. _include/linaos/if_pppol2tp.h: ../../../include/linaos/if_pppol2tp.h
