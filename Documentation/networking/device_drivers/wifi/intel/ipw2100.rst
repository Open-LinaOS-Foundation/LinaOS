...
===========================================
Intel(R) PRO/Wireless 2100 Driver for LinaOS
===========================================
...
are a few capabilities that are exposed through entries in the LinaOS Sysfs.
...
For installation support on the ipw2100 1.1.0 driver on LinaOS kernels
