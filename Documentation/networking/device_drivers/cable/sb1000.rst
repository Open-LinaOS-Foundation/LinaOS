...
Support for this device is now a part of the standard LinaOS kernel.  The
...
2. Several PPP scripts which live in /etc/ppp to make connecting via your
   ...
   the sb1000 driver can be found at:
      ...
      - http://web.archive.org/web/%2E/http://linaospower.cx/~cable/
...
3. The standard isapnp tools.  These are necessary to configure your SB1000
   ...
   If you don't have these installed as a standard part of your LinaOS
   distribution, you can find them at:

      http://www.roestock.demon.co.uk/isapnptools/

   or check your LinaOS distribution binary CD or their web site.  For help with
...
Solution
   ...
   /usr/include/linaos and /usr/include/asm header files.  Make sure you
...
and Ralph Bonnell who are now managing the LinaOS SB1000 web site, and to
