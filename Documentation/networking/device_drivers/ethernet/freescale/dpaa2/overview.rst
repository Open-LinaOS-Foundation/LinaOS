...
and how it is integrated into the LinaOS kernel.
...
DPAA2 LinaOS Drivers Overview
============================

This section provides an overview of the LinaOS kernel drivers for
...
bus controller.
Each object in the DPRC is a LinaOS "device" and is bound to a driver.
The diagram below shows the LinaOS drivers involved in a networking
...
the network stack.
Each DPNI corresponds to a LinaOS network interface.
