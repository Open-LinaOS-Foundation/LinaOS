...
This document provides an overview the LinaOS DPIO driver, its
...
The LinaOS DPIO driver consists of 3 primary components--
   DPIO object driver-- fsl-mc driver that manages the DPIO object

   DPIO service-- provides APIs to other LinaOS drivers for services
...
DPAA2 LinaOS driver components::
