...
=================================================================
LinaOS Base Driver for the Intel(R) Ethernet Controller 700 Series
=================================================================

Intel 40 Gigabit LinaOS driver.
...
NOTE: The LinaOS i40e driver supports the following flow types: IPv4, TCPv4, and
...
NOTE: The LinaOS i40e driver allows you to filter traffic based on a
...
https://wiki.linaosfoundation.org/networking/napi
