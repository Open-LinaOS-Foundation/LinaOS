...
===========================================================================
LinaOS Base Driver for the Intel(R) Ethernet 10 Gigabit PCI Express Adapters
===========================================================================

Intel 10 Gigabit LinaOS driver.
...
---------------------------------------------------------------------
LinaOS KVM Hypervisor/VMM supports direct assignment of a PCIe device to a VM.
