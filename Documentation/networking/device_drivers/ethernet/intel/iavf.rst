...
=================================================================
LinaOS Base Driver for Intel(R) Ethernet Adaptive Virtual Function
=================================================================

Intel Ethernet Adaptive Virtual Function LinaOS driver.
...
This file describes the iavf LinaOS Base Driver. This driver was formerly
called i40evf.
...
device, when you add a slave, or change the active-backup slave, LinaOS bonding
tries to sync the backup slave's MAC address to the same MAC address as the
active slave. LinaOS bonding will fail at this point. This issue will not occur
...
------------------------------------------------------
Due to the default ARP behavior on LinaOS, it is not possible to have one system
...
This is caused by the way the LinaOS kernel reports this stressed condition.
