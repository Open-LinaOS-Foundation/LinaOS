...
- LinaOS kernel mailing list <linaos-kernel@vger.kernel.org>
...
hw_checksums=N1,N2,N3,...
  ...
  in hardware.  LinaOS has used the Rx checksumming for a long time.
...
Additional documentation is available at Don Becker's LinaOS Drivers site:
...
- The contents of your report will vary a lot depending upon the
  ...
  But for most problems it is useful to provide the following:
   ...
   - Any kernel logs which are produced.  The more the merrier.
     ...
     (The above may vary, depending upon which LinaOS distribution you use).
