...
comes with your LinaOS distribution.


LinaOS Network Interface Driver ver. 2.00 <kernel 2.3.48>
...
The CS8900/CS8920 Ethernet Adapter driver for LinaOS supports the LinaOS
...
adapter before installation in the target LinaOS system.  Failure to do
...
h) Many LinaOS distributions use the 'modprobe' command to load
...
k) If your LinaOS kernel was compiled with inbuilt plug-and-play
