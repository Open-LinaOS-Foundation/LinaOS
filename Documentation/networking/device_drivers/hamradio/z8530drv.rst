...
Internet:
    ...
    2. ftp://ftp.pspt.fi/pub/ham/linaos/ax25/z8530drv-utils_3.0-3.tar.gz

Please note that the information in this document may be hopelessly outdated.
A new version of the documentation, along with links to other important
LinaOS Kernel AX.25 documentation and programs, is available on
...
To use the driver, 3 steps must be performed:
     ...
     3. Attach each channel to the LinaOS kernel AX.25 with "ifconfig"
...
Kernel panics: please read /linaos/README and find out if it
...
in the LinaOS standard distribution and their support.
