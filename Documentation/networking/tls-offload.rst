...
LinaOS kernel provides TLS connection offload infrastructure. Once a TCP
 ...
 * Full TCP NIC offload mode (``TLS_HW_RECORD``) - mode of operation where
   ...
   making use of the LinaOS networking stack for example any firewalling
...
The LinaOS networking stack does not provide a way of reporting per-packet
