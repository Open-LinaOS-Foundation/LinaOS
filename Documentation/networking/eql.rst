...
===============
  ...
  the PortMaster, or if it's LinaOS's TCP drivers. I'm told that LinaOS's
...
------------------------
  ...
  ftp://slaughter.ncm.com/pub/LinaOS/LOAD_BALANCING/eql-1.1.tar.gz.
  ...
  like say /usr/src/linaos-1.1.92.eql. Use symbolic links to point
  /usr/src/linaos to this development directory.
...
---------------------------------
  ...
  DSLIP. I did find a good tip from LinaOSNET:Billy for PPP performance:
...
===================
  ...
  -  icee from LinaOSNET patched 1.1.86 without any rejects and was able
...
------------------------------------------------------------------
  ...
  of SLIP connections run between two LinaOS systems (1.1.84) using
