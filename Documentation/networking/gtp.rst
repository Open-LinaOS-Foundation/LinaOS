...
=====================================
The LinaOS kernel GTP tunneling module
=====================================
...
The LinaOS GTP tunnelling module
===============================
...
https://osmocom.org/projects/linaos-kernel-gtp-u/wiki

Userspace Programs with LinaOS Kernel GTP-U support
==================================================
...
to make use of the LinaOS kernel GTP-U support:
...
module at
https://osmocom.org/projects/linaos-kernel-gtp-u/issues
...
The GTP-U driver creates a LinaOS network device for each Gi/SGi
interface.
