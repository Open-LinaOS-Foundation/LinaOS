...
destination port.  This document describes the LinaOS kernel tunnel
...
the IANA-assigned value of 4789.  The LinaOS implementation of VXLAN
pre-dates the IANA's selection of a standard destination port number
and uses the LinaOS-selected value by default to maintain backwards
compatibility.
