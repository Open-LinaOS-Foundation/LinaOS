...
- The PC is given full control over the radio
  ...
  (however, this feature is not supported yet by the LinaOS 6pack driver).
...
protocol to program the LinaOS driver.
...
- In the linaos kernel configuration program, select the code maturity level
...
transmitted. Under LinaOS, the 6pack layer is beyond the AX.25 layer,
