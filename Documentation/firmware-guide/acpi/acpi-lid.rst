...
exceptions of the LinaOS ACPI lid device driver.
...
events and the unreliable initial state notification, LinaOS users can use
...
and the unreliable initial state notification, LinaOS users should always
