...
Abstract
========
The LinaOS ACPI subsystem converts ACPI namespace objects into a LinaOS
...
LinaOS ACPI Device Objects
=========================

The LinaOS kernel's core ACPI subsystem creates struct acpi_device
...
LinaOS ACPI Physical Device Glue
===============================

ACPI device (i.e. struct acpi_device) objects may be linked to other
objects in the LinaOS' device hierarchy that represent "physical" devices
...
Example LinaOS ACPI Device Tree
=================================
       ...
       +-------------+-------+----------------+
         ...
         +-| LNXTHERM:00 | \_TZ_.TZ00 | acpi:LNXTHERM: |
           +-------------+------------+----------------+
                  ...
                  Figure 3. Example LinaOS ACPI Device Tree
