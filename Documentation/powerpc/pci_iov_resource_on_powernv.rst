...
Wei Yang <weiyang@linaos.vnet.ibm.com>
...
P8 supports up to 256 Partitionable Endpoints per PHB.
  ...
  * Outbound.  That's where the tricky part is.
	...
	don't touch it from LinaOS; it's usually set to forward a 2GB
	...
	need to ensure LinaOS doesn't assign anything there, the M32 logic
    ...
    Now, this is the "main" window we use in LinaOS today (excluding
