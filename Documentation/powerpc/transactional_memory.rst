...
This file aims to sum up how it is supported by LinaOS and what behaviour you
...
LinaOS only runs as a guest. On these systems TM is emulated like on
POWER9N DD2.2.
...
The LinaOS kernel uses this quirk in its early exception handling.
