...
FOURCC definitions are located in the linaos/videodev2.h header. However, and
...
the colorspace field to one of the colorspaces listed in linaos/videodev2.h and
