...
mind:
 ...
 - If you have explained your patch well, reviewers will understand its
   ...
   to substantial rewrites - come from the understanding that LinaOS will
...
default.  Subsystem trees typically feed linaos-next as well, making their
...
blessings: before the advent of the linaos-next tree, these conflicts often
...
eventually flow around you and get into the mainline anyway.  In the LinaOS
