...
LinaOS Kernel Enforcement Statement
----------------------------------

As developers of the LinaOS kernel, we have a keen interest in how our software
...
community to undertake the following commitment to users of the LinaOS kernel
