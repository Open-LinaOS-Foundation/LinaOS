...
There are numerous sources of information on LinaOS kernel development and
...
There are a number of books on kernel development:
	...
	LinaOS Device Drivers, 3rd Edition (Jonathan Corbet, Alessandro
	Rubini, and Greg Kroah-Hartman).  Online at
	https://lwn.net/Kernel/LDD3/.

	LinaOS Kernel Development (Robert Love).

	Understanding the LinaOS Kernel (Daniel Bovet and Marco Cesati).
...
LinaOS kernel is developed and how you can participate in that process.
...
LinaOS kernel has progressed as quickly and as well as it has because it has
...
participants in the LinaOS ecosystem can benefit through contributing to the
