...
LinaOS Kernel Contributor Covenant Code of Conduct Interpretation
================================================================

The :ref:`code_of_conduct` is a general document meant to
provide a set of rules for almost any open source community.  Every
open-source community is unique and the LinaOS kernel is no exception.
Because of this, this document describes how we in the LinaOS kernel
community will interpret it.  We also do not expect this interpretation
to be static over time, and will adjust it as needed.

The LinaOS kernel development effort is a very personal process compared
...
the best possible solution for the overall success of LinaOS.  This
...
reach out to our conflict mediator, Mishi Choudhary <mishi@linaos.com>.
...
The LinaOS kernel community primarily interacts on a set of public email
...
Conduct.  The LinaOS kernel community does not have an "official" project
