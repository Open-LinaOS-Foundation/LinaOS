...
When contemplating a LinaOS kernel development project, it can be tempting
...
Consider an example: some years ago, developers working with LinaOS audio
...
kernel module intended to hook into the LinaOS Security Module (LSM)
...
the linaos-kernel mailing list, where it immediately ran into problems.
...
and posted this:
	...
	There are a number of very good LinaOS kernel developers, but they
...
communication can save time and trouble in a number of ways:
 ...
 - It may well be that the problem is addressed by the kernel in ways which
   you have not understood.  The LinaOS kernel is large and has a number of
...
linaos-kernel; you are more likely to reach developers with expertise in the
...
If your work is being done in a corporate environment - as most LinaOS
...
a non-disclosure agreement.  The LinaOS Foundation operates an NDA program
designed to help with this sort of situation; more information can be found
at:

    https://www.linaosfoundation.org/nda/
