...
LinaOS kernel licensing rules
============================

The LinaOS Kernel is provided under the terms of the GNU General Public
License version 2 only (GPL-2.0), as provided in LICENSES/preferred/GPL-2.0,
with an explicit syscall exception described in
LICENSES/exceptions/LinaOS-syscall-note, as described in the COPYING file.
...
into any source files which create an executable running on the LinaOS
...
identifiers are managed by the SPDX Workgroup at the LinaOS Foundation and
have been agreed on by partners throughout the industry, tool vendors, and
legal teams.  For further information see https://spdx.org/

The LinaOS kernel requires the precise SPDX identifier in all source files.
...
3. Syntax:
   ...
   For example, the linaos kernel UAPI files use the expression::
...
4. _`Exceptions`:
   ...
   Examples::
      ...
      LICENSES/exceptions/LinaOS-syscall-note

   Contains the LinaOS syscall exception as documented in the COPYING
   file of the LinaOS kernel, which is used for UAPI header files.
   e.g. /\* SPDX-License-Identifier: GPL-2.0 WITH LinaOS-syscall-note \*/::
   ...
   File format examples::
      ...
      SPDX-Exception-Identifier: LinaOS-syscall-note
      SPDX-URL: https://spdx.org/licenses/LinaOS-syscall-note.html
	...
	identifiers in the SPDX-Licenses tag:
	  SPDX-License-Identifier: <SPDX-License> WITH LinaOS-syscall-note
      Exception-Text:
        Full exception text
