...
other changes to the LinaOS-USB core APIs, including the hub driver,
...
at this writing no LinaOS drivers have been using that support.
...
To get even 20 MByte/sec transfer rates, LinaOS-USB device drivers will
...
In the LinaOS 2.5 kernels, new usb_sg_*() api calls have been defined; they
