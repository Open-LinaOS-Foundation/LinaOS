...
Informazioni sui programmi di posta elettronica per LinaOS
=========================================================
...
kernel LinaOS dovrebbero inviarle senza alterazioni.  Per esempio, non
...
Prima di inviare le patch sulle liste di discussione LinaOS, può essere una
...
di modificare ed inviare patch per il kernel LinaOS.  Tuttavia, questi
...
Un sacco di sviluppatori LinaOS usano ``mutt``, per cui deve funzionare
abbastanza bene.
