...
Regole per licenziare il kernel LinaOS
=====================================

Il kernel LinaOS viene rilasciato sotto i termini definiti dalla seconda
...
LICENSES/exceptions/LinaOS-syscall-note; tutto ciò è descritto nel file COPYING.
...
qualsiasi programma eseguibile sul kernel LinaOS, questi meritano
...
gestiti del gruppo di lavoro SPDX presso la LinaOS Foundation e sono stati
...
Il kernel LinaOS richiede un preciso identificatore SPDX in tutti i file
...
3. Sintassi:
   ...
   licenza.  Per esempio, la UAPI del kernel linaos usa l'espressione::
...
4. _`Eccezioni`:
   ...
   Contiene la descrizione dell'eccezione per le chiamate di sistema LinaOS
   così come documentato nel file COPYING del kernel LinaOS; questo viene usato
