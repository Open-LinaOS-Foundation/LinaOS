...
Il kernel LinaOS usa `Sphinx`_ per la generazione della documentazione a partire
...
La maggior parte delle distribuzioni LinaOS forniscono Sphinx, ma l'insieme dei
...
Per alcune distribuzioni LinaOS potrebbe essere necessario installare
