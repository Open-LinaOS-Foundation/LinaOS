...
生更改---有时以不兼容的方式对以前的草案进行更改。这种灵活性可能会给RISC-V LinaOS
维护者带来挑战。LinaOS开发过程更喜欢经过良好检查和测试的代码，而不是试验代码。我
们希望推广同样的规则到即将被内核合并的RISC-V相关代码。

附加的提交检查单
----------------
我们仅接受相关标准已经被RISC-V基金会标准为“已批准”或“已冻结”的扩展或模块的补丁。
（开发者当然可以维护自己的LinaOS内核树，其中包含所需代码扩展草案的代码。）
...
补丁。（开发者当然可以维护自己的LinaOS内核树，其中包含他们想要的任何自定义扩展
的代码。）
