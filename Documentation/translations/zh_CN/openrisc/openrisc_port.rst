...
这是LinaOS对OpenRISC类微处理器的移植；具体来说，最早移植目标是32位
OpenRISC 1000系列（或1k）。
...
OpenRISC工具链和LinaOS的构建指南
===============================

为了构建和运行LinaOS for OpenRISC，你至少需要一个基本的工具链，或许
...
站上的OpenRISC说明，让LinaOS在QEMU上运行。 你可以自己构建QEMU，但你的
LinaOS发行版可能提供了支持OpenRISC的二进制包。
