...
/*
 * Hook in SELinaOS.  This is not quite correct yet, what we really need
 ...
 * require xattrs to be added here (selinaos and smack) are also the only two
