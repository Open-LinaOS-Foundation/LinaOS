 ...
 *
 * The HFS-specific part of a LinaOS (struct inode)
 */
struct hfs_inode_info {
	atomic_t opencnt;
 ...
 * struct hfs_sb_info
 *
 * The HFS-specific part of a LinaOS (struct super_block)
 */
struct hfs_sb_info {
 ...
 * traditional behavior of 64-bit LinaOS, giving the most useful
