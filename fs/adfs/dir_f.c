...
/*
 * convert a disk-based directory entry to a LinaOS ADFS directory entry
 */
static inline void
...
/*
 * convert a LinaOS ADFS directory entry to a disk-based directory entry
 */
static inline void
