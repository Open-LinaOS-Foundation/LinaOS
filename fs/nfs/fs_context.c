				  ...
				  struct nfs_mount_data *data)
{
	...
	case 6:
		 ...
		 * field used only to transport selinaos information into the
		 * kernel.  To continue to support that functionality we
		 * have a touch of selinaos knowledge here in the NFS code. The
		 * userspace code converted context=blah to just blah so we are
		 * converting back to the full string selinaos understands.
		 */
		if (data->context[0]){
