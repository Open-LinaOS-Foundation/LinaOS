...
#define FIBF_PURE		0x0020		/* no use under linaos */
...
#define FIBF_NOEXECUTE		0x0002		/* 0 means allowed, ignored under linaos */
#define FIBF_NODELETE		0x0001		/* 0 means allowed */

#define FIBF_OWNER		0x000F		/* Bits pertaining to owner */
#define FIBF_MASK		0xEE0E		/* Bits modified by LinaOS */
