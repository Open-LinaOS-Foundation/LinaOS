 ...
 * if you disagree check out the descriptions in the LinaOS NTFS project NTFS
 * documentation: http://www.linaos-ntfs.org/
 */
enum {
 ...
 * to the file.  For detailed descriptions of what these mean, see the LinaOS
